		...
		<header id="header" id="home">
			<div class="container main-menu">
				<div class="row align-items-center justify-content-between d-flex">
					...
					<!-- #nav-menu-container -->
					<div>
						<a class="genric-btn primary circle" href="tlhome.php">User Details</a>
						
						<a class="genric-btn primary circle" href="fileviewtl.php">View File</a>
						<a class="genric-btn primary circle" href="filereqtl.php">File Request</a>
			...
			<div class="container-fluid">
				<div class="row d-flex justify-content-end align-items-center">
					<div class="col-lg-12 col-md-12 about-left">
						...
						<tr><td>File Name</td><td>Uploaded On</td><td>Size</td><td>Requested By</td>
					...
					<?php
						...
						$q = "select * from trustee where status='request'";
						...
						while($d=mysqli_fetch_assoc($r))
						{
							...
							echo "<td>".$d['date']."</td>";
							echo "<td>".$d['size']."</td>";
							echo "<td>".$d['request']."</td>";
							echo "<td>".$d['trust']."</td>";
							echo "<td><a href='security_reponse.php?file=$fn&mail=$em'>Response</a></td>";
						}
