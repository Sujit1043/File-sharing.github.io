		...
		<header id="header" id="home">
			<div class="container main-menu">
				<div class="row align-items-center justify-content-between d-flex">
					...
					<!-- #nav-menu-container -->
					<div>
						<a class="genric-btn primary circle" href="cloudupload.php">Cloud Upload</a>
						<a class="genric-btn primary circle" href="clouddownload.php">Cloud Downloads</a>
			...
			<div class="container-fluid">
				<div class="row d-flex justify-content-end align-items-center">
					<div class="col-lg-12 col-md-12 about-left">
						<h1>Cloud Download Details</h1>
						<br>
						<table border="2" cellspacing="10" cellpadding="10">
						<tr><td>Id</td><td>File Name</td><td>Downloaded By</td>
						</tr>
						
					<?php

						require("connection.php");
						$q = "select * from f_download";
