			...
			<div class="container-fluid">
				<div class="row d-flex justify-content-end align-items-center">
					<div class="col-lg-12 col-md-12 about-left">
						...
						<tr><td>File Name</td><td>Uploaded On</td><td>Size</td>
						<td>Requested By</td><td>Status</td><td>Secret Key</td>
						</tr>
						
					<?php

						require("connection.php");
						$q = "select * from authority where status='key request'";
						...
						while($d=mysqli_fetch_assoc($r))
						{
							...
							echo "<td>".$d['author']."</td>";
							echo "<td><a href='secretkey.php?file=$fn&mail=$em'>Send Key</a></td>";
